...
def create_app(config: Config, ingest_state: IngestState, ingest_state_path: Path,
    ...
    async def get_stats() -> JSONResponse:
        ...
        tokens_today: dict[str, int] = {
            ...
            "cache_read": today_entry.cache_read if today_entry else 0,
            "cache_creation": today_entry.cache_creation if today_entry else 0,
        }
...
<div class="section">
  ...
  <div class="tokens" style="grid-template-columns:repeat(5,1fr)">
    ...
    <div title="Input tokens sent to the model"><div class="tv" id="v-tin">-</div><div class="tl">Input</div></div>
    <div title="Tokens read from prompt cache (discounted input)"><div class="tv" id="v-tcr">-</div><div class="tl">Cache Read</div></div>
    <div title="Tokens written to prompt cache (billed as input)"><div class="tv" id="v-tcc">-</div><div class="tl">Cache Create</div></div>
    <div title="Tokens generated by the model"><div class="tv" id="v-tout">-</div><div class="tl">Output</div></div>
  </div>
</div>
<div class="section">
